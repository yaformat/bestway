...
const toggleGroup = () => {
  ...
  props.data.opened = isOpen.value;
};
      ...
      <div class="resources-list">
        ...
        >
          <template #item="{ element, index }">
            <div class="draggable-item">
                <TechCardAdditionalResource 
                  :id="index" 
                  :data="element"
                  :allowSorting="props.data.resources.length > 1"
        ...
        <div v-if="props.data.resources && props.data.resources.length > 0" class="totals-item">
          ...
          <div class="totals-mobile">
            ...
            <div class="totals-values">
              <div class="total-item">
                ...
                <strong>{{ props.totals.brutto.toFixed(2) }}</strong>
              </div>
              <div class="total-item">
          ...
          <div class="totals-desktop">
            ...
            <div class="total-cell total-quantity">
              <strong>{{ props.totals.brutto.toFixed(2) }}</strong>
            </div>
...
/* Заголовки для десктопа - показываем по умолчанию */
.resource-headers {
  display: grid;
...
/* Десктопные итоги - показываем по умолчанию */
.totals-desktop {
  display: grid;
  grid-template-columns: 2fr 200px 150px 120px;
  gap: 16px;
