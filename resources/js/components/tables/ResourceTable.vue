<template>
  <div>
    ...
    >
      <!-- Все ваши template слоты остаются без изменений -->
          ...
          <div v-else>
            ...
            <VBtn icon variant="text" size="small" color="medium-emphasis">
              ...
              <VMenu activator="parent">
                <VList>
                  <VListItem @click="openCopyDialog(item)">
                    <template #prepend>
                      <VIcon icon="mdi-content-copy" />
                    </template>
                    <VListItemTitle>Копировать</VListItemTitle>
                  </VListItem>
...
const headers = [
  ...
  { title: 'Товары', key: 'product_items_count', sortable: false },
  { title: 'Срок хранения', key: 'shelf_life_days', sortable: false },
  { title: 'Тех. карты', key: 'tech_cards_count', sortable: false },
