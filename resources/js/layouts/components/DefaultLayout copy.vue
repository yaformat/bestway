...
// const NavBarI18n = defineAsyncComponent(() => import('@/layouts/components/NavBarI18n.vue'))
// const NavBarNotifications = defineAsyncComponent(() => import('@/layouts/components/NavBarNotifications.vue'))
// const NavSearchBar = defineAsyncComponent(() => import('@/layouts/components/NavSearchBar.vue'))
