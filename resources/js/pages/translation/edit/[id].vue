...
console.log('edit translation id: ' + route.params.id)
...
translationListStore.fetchSingleTranslation(Number(route.params.id)).then(response => {
  console.log('go fetch translation by Id');
  console.log(response.data);
  translationDataLocal.value = response.data;
  console.log(translationDataLocal.value);
}).catch(error => {
  console.log(error)
})
...
console.log(translationData);
  ...
  translationListStore.editTranslation(translationData).then(response => {
...
>
  <VRow>
    <VCol cols="12">
      <VCard title="Редактирование группы переводов">
        <VCardText>
            <VRow>
              <!-- Name -->
              <VCol
